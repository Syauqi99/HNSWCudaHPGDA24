...
int main(int argc, char* argv[]) {
    ...
    const string log_path = result_base_dir + "log_allocation-" + save_name;
    const string result_path = result_base_dir + "result_allocation-" + save_name;
    results.save(log_path, result_path);

    const string times_path = result_base_dir + "times_allocation-" + save_name;
